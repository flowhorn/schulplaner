...
import { LeaveGroupHandler, LeaveGroupParams } from '../handler/leave_group_handler';
...
export const leaveGroupFunction = functions.region(europeRegion).https.onCall(async (data, context) => {
