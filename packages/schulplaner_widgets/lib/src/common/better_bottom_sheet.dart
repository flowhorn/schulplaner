...
///    sheets can be created and displayed with the [showBetterModalBottomSheet]
///    function.
///
/// The [BottomSheet] widget itself is rarely used directly. Instead, prefer to
/// create a persistent bottom sheet with [ScaffoldState.showBottomSheet] and a modal
/// bottom sheet with [showBetterModalBottomSheet].
///
/// See also:
///
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showBetterModalBottomSheet], for modal bottom sheets.
  const BottomSheet(
      {Key key,
            ...
            builder: (BuildContext context, Widget child) {
              return ClipRect(
                  child: CustomSingleChildLayout(
                      delegate:
                          _ModalBottomSheetLayout(widget.route.animation.value),
                      child: BottomSheet(
                          animationController:
...
///    passed as the `builder` argument to [showBetterModalBottomSheet].
...
/// [showBetterModalBottomSheet] function.
///
...
///  * [showBetterModalBottomSheet], which can be used to display a modal bottom
///    sheet.
