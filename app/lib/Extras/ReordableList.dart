...
class _ReorderableListState extends State<ReorderableList>
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[widget.child, _DragProxy()],
    );
  }
  ...
  Future<void> _dragEnd(DragEndDetails details) async {
    ...
    _finalAnimation.addListener(() {
      _dragProxy.offset = Tween<double>(
        begin: dragProxyOffset,
        end: originalOffset,
  ...
  final _items = HashMap<Key, _ReorderableItemState>();
  ...
  Widget build(BuildContext context) {
    ...
    return _widget != null && _size != null && _offset != null
        ? Positioned.fromRect(
            ...
            rect: Rect.fromLTWH(0.0, _offset - decorationHeight, _size.width,
