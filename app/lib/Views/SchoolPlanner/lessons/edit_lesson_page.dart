                ...
                children: <Widget>[
                  ...
                  showlongerlessons
                      ...
                      : ListTile(
                          ...
                          subtitle: Text((data.start.toString() +
                              '. ' +
                              getString(context).lesson)),
                          trailing: IconButton(
                          ...
                          onTap: () {
                            selectItem<int>(
                                ...
                                items: buildIntList(
                                    database.settings.data!.maxlessons,
                                    start: database.settings.data!.zero_lesson
                                        ? 0
                                        : 1),
                                builder: (context, item) {
                                  return ListTile(
                            ...
                            EditCustomField(
                              ...
                              onClicked: (context) {
                                return selectTeacher(
                                  ...
                                  if (newteacher != null) {
                                    data.teacher =
                                        TeacherLink.fromTeacher(newteacher);
                                    notifier.notifyListeners();
                                  }
                                });
                              },
                      ...
                      builder: (context) {
                        ...
                        String? getEndTime() {
                          if (data.overridentime?.end != null) {
                            ...
                            if (data.end != null) {
                              LessonTime? lessontimeend =
                                  database.getSettings().lessontimes[data.end];
